package br.gov.sp.fatec.projetomineda.security;
...
public class JwtUtils {
    ...
    public static Authentication parseToken(String token) throws JsonParseException, JsonMappingException, IOException {
        ...
        // deu o parser e retorna um authentication, faz um build, e retorna um authentication com nome e senha ou nome,senha e authorities (2 construtores)
